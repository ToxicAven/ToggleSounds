...
object DisableSound : ISound {
    private val location = ResourceLocation("sounds/disable.ogg")
    ...
    override fun createAccessor(handler: SoundHandler): SoundEventAccessor {
        return SoundEventAccessor(location, "Disabled Module")
    }

    override fun getSound(): Sound {
        return Sound("Disable", 100000f, 1.0f, 1, Sound.Type.SOUND_EVENT, false)
    }
